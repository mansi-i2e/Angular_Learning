...
const employees: Employee[] = [
    ...
    },
    {
        ...
        Position: "Sales Representative",
        TitleOfCourtesy: "Mrs.",
        BirthDate: new Date("1957-09-19"),
        HireDate: new Date("2012-05-03"),
    ...
    },
    {
        ...
        Position: "Sales Representative",
        TitleOfCourtesy: "Mr.",
        BirthDate: new Date("1986-01-27"),
        HireDate: new Date("2012-11-15"),
        ...
        Extension: "452",
        Photo: "https://js.devexpress.com/Demos/WidgetsGallery/JSDemos/images/employees/06.png",
        Notes: "Education includes a BA in psychology from Colorado State University in 1990.  She also completed \"The Art of the Cold Call.\"  Brett is a member of Toastmasters International.",
        ReportsTo: 2
    }
];
